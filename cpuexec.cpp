...
char* FromRAMToChar()
{
	char* someChar = new char[1048]();
	memset(someChar, '\0', 1048);

	// Can get what you want from RAM here
	// ----------------------------------------------
...
void ReportToController(bool buttonPushed)
{
